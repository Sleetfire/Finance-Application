...
CREATE SCHEMA mail_scheduler_service;
CREATE SCHEMA quartz;

CREATE TABLE mail_scheduler_service."schedule"
(
    uuid       uuid                        NOT NULL,
...
ALTER TABLE IF EXISTS mail_scheduler_service."schedule"
    OWNER to "mail-scheduler-service_user";

CREATE TABLE mail_scheduler_service."report"
(
    uuid      uuid                        NOT NULL,
    dt_create timestamp without time zone NOT NULL,
    dt_update timestamp without time zone NOT NULL,
...
ALTER TABLE IF EXISTS mail_scheduler_service."report"
    OWNER to "mail-scheduler-service_user";

CREATE TABLE mail_scheduler_service."scheduled_report"
(
    uuid          uuid                        NOT NULL,
    dt_create     timestamp without time zone NOT NULL,
    dt_update     timestamp without time zone NOT NULL,
    ...
    CONSTRAINT scheduled_report_pk PRIMARY KEY (uuid),
    CONSTRAINT schedule_fk FOREIGN KEY (schedule_uuid)
        REFERENCES mail_scheduler_service."schedule" (uuid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT report_fk FOREIGN KEY (report_uuid)
        REFERENCES mail_scheduler_service."report" (uuid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);

ALTER TABLE IF EXISTS mail_scheduler_service."scheduled_report"
    OWNER to "mail-scheduler-service_user";
