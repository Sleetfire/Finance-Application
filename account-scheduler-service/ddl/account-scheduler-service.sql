...
CREATE SCHEMA "account_scheduler_service";
CREATE SCHEMA "quartz";

CREATE TABLE account_scheduler_service.operation
(
    uuid uuid NOT NULL,
...
ALTER TABLE IF EXISTS account_scheduler_service.operation
    OWNER to "account-scheduler-service_user";
	
CREATE TABLE account_scheduler_service.schedule
(
    uuid uuid NOT NULL,
    dt_create timestamp without time zone NOT NULL,
    dt_update timestamp without time zone NOT NULL,
    ...
    CONSTRAINT schedule_pk PRIMARY KEY (uuid)
);

ALTER TABLE IF EXISTS account_scheduler_service.schedule
    OWNER to "account-scheduler-service_user";
	
CREATE TABLE account_scheduler_service.scheduled_operation
(
    uuid uuid NOT NULL,
    dt_create timestamp without time zone NOT NULL,
    dt_update timestamp without time zone NOT NULL,
    ...
    CONSTRAINT scheduled_operation_pk PRIMARY KEY (uuid),
    CONSTRAINT schedule_fk FOREIGN KEY (schedule_uuid)
        REFERENCES account_scheduler_service.schedule (uuid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT operation_fk FOREIGN KEY (operation_uuid)
        REFERENCES account_scheduler_service.operation (uuid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);

ALTER TABLE IF EXISTS account_scheduler_service.scheduled_operation
    OWNER to "account-scheduler-service_user";
