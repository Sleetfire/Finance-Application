...
import by.it.academy.account_scheduler_service.models.deserializers.LocalDateDeserializer;
import by.it.academy.account_scheduler_service.models.enums.TimeUnit;
import by.it.academy.account_scheduler_service.models.serializers.LocalDateSerializer;
...
public class Schedule {
    ...
    public Schedule(UUID uuid, LocalDateTime dtCreate, LocalDateTime dtUpdate, LocalDate startTime,
    ...
    public static class Builder {
        ...
        public Schedule build() {
            return new Schedule(this.uuid, this.dtCreate, this.dtUpdate, this.startTime, this.stopTime, this.interval,
                    this.timeUnit);
        }
    }
}
