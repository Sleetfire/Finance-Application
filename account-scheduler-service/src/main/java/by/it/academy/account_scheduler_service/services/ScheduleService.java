...
import by.it.academy.account_scheduler_service.repositories.api.IScheduleRepository;
...
public class ScheduleService implements IScheduleService {
    ...
    public List<Schedule> getAll() {
        ...
        scheduleEntityList.forEach(scheduleEntity -> scheduleList.add(this.conversionService.convert(scheduleEntity, Schedule.class)));
        return scheduleList;
    }
