package by.it.academy.account_scheduler_service.controllers.advice;

import by.it.academy.account_scheduler_service.exception.*;
import by.it.academy.account_scheduler_service.models.errors.MultipleResponseErrors;
import by.it.academy.account_scheduler_service.models.errors.SingleResponseError;
...
public class GlobalExceptionAdvice {
    ...
    public ResponseEntity<MultipleResponseErrors<ValidationError>> validationHandler(ValidationException exception) {
        ...
        return new ResponseEntity<>(new MultipleResponseErrors(exception.getMessage(), exception.getErrors()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
