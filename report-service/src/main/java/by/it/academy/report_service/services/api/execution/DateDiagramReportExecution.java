...
public class DateDiagramReportExecution implements IReportExecution {

    private final DiagramService diagramService;

    public DateDiagramReportExecution(DiagramService diagramService) {
    ...
    public IReport create(Map<String, Object> paramMap) {
        ...
        return Report.Builder.createBuilder()
                ...
                .setType(ReportType.DATE_DIAGRAM)
                .setDescription(this.createDescription(paramMap, "Dates diagram"))
                .setParams(paramMap)
                .build();
    }
